...
# experiment_name <- 'tencent-mpnn-neighborhood-expansion-old'
# 
...
df_shared <- read.csv(file.path(results_dir, 'lc-NE-real.csv')) %>% 
...
ggsave(file.path(figures_dir, 'implict-hydrogens.pdf'), p, width = 30, height = 20, units = "cm")
p
```
