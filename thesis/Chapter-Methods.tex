...
The term after the sum is the log MAE for a given J-coupling type - e.g. $1JHC$. The score is an average over all J-coupling types. In this way, the final score treats all J-coupling types as equally important independent of the number of interactions (which varies markedly from type to type).
