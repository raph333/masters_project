...
\begin{centering}
	\begin{tabular}{||c | c | c||} 
		...
		\hline\hline
		\textit{LightGBM}~\cite{Ke2017} with distance and atom type & \ref{sec:dist-atom-type} & -1.19 \\ 
	...
	\end{tabular}
	\vspace{0.5cm}
	\caption{Summary of the results of different experiments from the Kaggle competition 'Predicting Molecular Properties'. *The score is based on the MAE and defined in Equation~\ref{eq:champs-score} (in short, a lower score is better).}
...
\begin{centering}
	\begin{tabular}{||c | c | c||} 
		...
		\hline\hline
		Baseline (Chen et. al.~\cite{Chen2019})  & \ref{sec:neighborhood-expansion} & 0.0569 \\
...
\subsection{Message passing functions with and without shared weights give the same results.}
